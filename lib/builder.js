...
(function() {
  ...
  module.exports = api = {
    ...
    prepConfig: function(info, opts) {
      ...
      if ((info.__prepped != null) && info.__prepped === true) {
        return;
      }
      for (output in info) {
        config = info[output];
  ...
  build_js_package = function(sources, opts) {
    ...
    identifier = (_ref = opts.ident || opts.options.ident) != null ? _ref : 'require';
    autoStart = (_ref1 = opts.autoStart || opts.options.autoStart) != null ? _ref1 : false;
