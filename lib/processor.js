...
(function() {
  ...
  project_package = (function() {
    try {
      return require("" + project_root + path.sep + "package.json");
    } catch (ex) {
      return {};
    }
  })();
  ...
  compontent_package = (function() {
    try {
      return require("" + project_root + path.sep + "component.json");
    } catch (ex) {
      return {};
    }
  })();
  ...
  build_package = (function() {
    try {
      return require("" + project_root + path.sep + "build.json");
    } catch (ex) {
      return {};
    }
  })();
  ...
  */
  ...
  compile_stylus = function(stylus, nib, source, opts, callback) {
    ...
    if (((_ref = opts.current_file.extra) != null ? _ref.sourcePath : void 0) != null) {
      options.paths.push(opts.current_file.extra.sourcePath);
    }
    return stylus(source).set('filename', opts.current_file.filepath || 'generated.css').set('paths', opts.load_paths).set(options).use(nib()).render(callback);
  };
  ...
  addProcessor('css').ext('.styl', '.stylus').requires('stylus', 'nib').build(function(stylus, nib) {
    var load_paths;
  ...
  addProcessor('js').ext('.estyl', '.estylus').requires('stylus', 'nib').build(function(stylus, nib) {
    var load_paths;
    load_paths = [process.cwd(), path.dirname(__dirname)];
    return function(source, opts, converted) {
      var _ref;
      opts.load_paths = load_paths;
      ((_ref = opts.stylus) != null ? _ref : opts.stylus = {}).compress = true;
      return compile_stylus(stylus, nib, source, opts, function(err, css) {
        if (err != null) {
          return converted(err, null, opts);
        } else {
