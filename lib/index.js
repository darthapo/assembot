...
(function() {
  var Bot, assembler, assembot, defaults, loadFirstLocalPackage, loadOptions, loadTargets, loadedFrom, loadedOptions, log, packager, path, plugins, processor, project_root, resourcelist, _,
    __slice = [].slice;
  ...
  loadFirstLocalPackage = function() {
    ...
    loadedFrom = 'defaults';
    return loadedOptions = defaults;
  };

  loadTargets = function(options) {
    var nfo, opts, src_targets, targets, tgt, tgt_opts, _ref, _ref1;
    nfo = options != null ? options : loadFirstLocalPackage('package.json', 'component.json', 'build.json', 'assembot');
